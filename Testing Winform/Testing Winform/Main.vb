...
#Region "Object Declarations"
    ...
    'Import to Excel
    'Public ListOfFilesCopied As New List(Of String) From {"C:\Users\" & Environment.UserName & "\Desktop\Save to Excel\EDS - 871184 - Guyed Anchor Block Foundation (4.1.0).xlsm"}
    ...
    'Import to EDS
    'Public ListOfExcelFiles As New List(Of String) From {"C:\Users\" & Environment.UserName & "\Desktop\Save to EDS\Guyed Anchor Block Foundation (4.1.0) - 10-11-2021.xlsm"}
