...
#Region "Object Declarations"
    ...
    'Import to EDS
    Public ListOfExcelFiles As New List(Of String) From {"C:\Users\" & Environment.UserName & "\source\repos\Datatransferer NuGet\DataTransferer\Templates\Drilled Pier Foundation.xlsm"}
