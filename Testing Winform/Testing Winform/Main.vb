...
#Region "Object Declarations"
    ...
    'Import to EDS
    Public ListOfExcelFiles As New List(Of String) From {"C:\Users\" & Environment.UserName & "\Desktop\Save to EDS\Guyed Anchor Block Foundation (4.1.0) - 10-8-2021.xlsm"}
