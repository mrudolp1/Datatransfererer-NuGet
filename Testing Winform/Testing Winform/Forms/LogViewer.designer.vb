...
#Region "Component Designer generated code"
    ...
    Private Sub InitializeComponent()
        ...
        Me.gvTestLog = New DevExpress.XtraGrid.Views.Grid.GridView()
        ...
        CType(Me.gvTestLog, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.gcTestLog.MainView = Me.gvTestLog
        Me.gcTestLog.Name = "gcTestLog"
        Me.gcTestLog.Size = New System.Drawing.Size(626, 371)
        Me.gcTestLog.TabIndex = 25
        Me.gcTestLog.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {Me.gvTestLog})
        '
        'gvTestLog
        '
        Me.gvTestLog.GridControl = Me.gcTestLog
        Me.gvTestLog.HorzScrollVisibility = DevExpress.XtraGrid.Views.Base.ScrollVisibility.Always
        Me.gvTestLog.Name = "gvTestLog"
        Me.gvTestLog.OptionsBehavior.AllowAddRows = DevExpress.Utils.DefaultBoolean.[False]
        Me.gvTestLog.OptionsBehavior.AllowDeleteRows = DevExpress.Utils.DefaultBoolean.[False]
        Me.gvTestLog.OptionsBehavior.ReadOnly = True
        Me.gvTestLog.OptionsCustomization.AllowColumnMoving = False
        Me.gvTestLog.OptionsFilter.AllowAutoFilterConditionChange = DevExpress.Utils.DefaultBoolean.[False]
        Me.gvTestLog.OptionsFilter.AllowFilterEditor = False
        Me.gvTestLog.OptionsFilter.InHeaderSearchMode = DevExpress.XtraGrid.Views.Grid.GridInHeaderSearchMode.Disabled
        Me.gvTestLog.OptionsLayout.Columns.AddNewColumns = False
        Me.gvTestLog.OptionsLayout.Columns.RemoveOldColumns = False
        Me.gvTestLog.OptionsView.BestFitMode = DevExpress.XtraGrid.Views.Grid.GridBestFitMode.Full
        Me.gvTestLog.OptionsView.ColumnAutoWidth = False
        Me.gvTestLog.OptionsView.ColumnHeaderAutoHeight = DevExpress.Utils.DefaultBoolean.[True]
        Me.gvTestLog.OptionsView.ShowGroupPanel = False
        '
        'pnCheckButtons
        '
        ...
        CType(Me.gvTestLog, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Friend WithEvents gvTestLog As DevExpress.XtraGrid.Views.Grid.GridView
