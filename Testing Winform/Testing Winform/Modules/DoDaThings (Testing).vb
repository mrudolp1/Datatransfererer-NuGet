...
#Region "Import Input"
    ...
    Public Function ImportingInputs(
        ...
        If importingFrom.Extension.ToLower = ".xlsm" Then
            ...
            If Import_Previous_Version(myLog, myXL.Item1, importingTo, macroname, params, excelVisible, prefix) Then
                myLog.NewLine("INFO | Import Inputs Completed for: " & importingTo.FullName)
                ...
                'End If
            Else
                myLog.NewLine("WARNING | Import Inputs NOT Completed for: " & importingTo.FullName)
            End If
        End If
    ...
    Public Function Import_Previous_Version(
        ...
        If workbookFile Is Nothing Or String.IsNullOrEmpty(macroName) Then
            myLog.NewLine("ERROR | workbookFile or macroName parameter is null or empty")
            Return False
        End If
        ...
        Try
            If workbookFile.Exists Then
                ...
                myLog.NewLine("DEBUG | Tool: " & toolFileName)
                myLog.NewLine("DEBUG | BEGIN MACRO: " & macroName)
                ...
                If params.Item1 IsNot Nothing And params.Item2 IsNot Nothing And params.Item3 Then
                    ...
                    myLog.NewLine("DEBUG | END MACRO:  " & macroName)
                Else
                    myLog.NewLine("ERROR | Parameters not specific ")
                    myLog.NewLine("DEBUG | Tool: " & toolFileName & " failed to import inputs")
                    isSuccess = False
                End If

                xlWorkBook.Save()
            Else
                myLog.NewLine("ERROR | " & workbookFile.FullName & " path not found!")
            End If
        Catch ex As Exception
            errorMessage = ex.Message
            myLog.NewLine("ERROR | " & ex.Message)
            isSuccess = False
        Finally
            Try
                ...
                End If
            Catch ex As Exception
                myLog.NewLine("WARNING | Could not close Excel Workbook: " & toolFileName)
            End Try
        End Try
...
#End Region
    ...
    Public Sub LoadMyWOS(ByVal site As SiteData, ByVal myGc As GridControl, ByVal mygv As GridView)
        ...
        myGc.DataSource = ds.Tables("MyWOs")
    ...
    Public Function CreateStructure(ByVal filesPath As String, ByRef strctr As EDSStructure, ByVal site As SiteData, Optional ByVal deleteAdditionalTNXfiles As Boolean = True) As String
