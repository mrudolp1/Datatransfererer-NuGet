...
#Region "Define"
    ...
    <Category("Pad"), Description(""), DisplayName("Tower Centroid Offset")>
     <DataMember()> Public Property tower_centroid_offset() As Boolean?
        Get
...
#Region "Load From Excel"
    Public Overrides Sub LoadFromExcel()
        ...
        If excelDS.Tables.Contains("Unit Base General Details EXCEL") Then
            ...
            Me.ID = DBtoNullableInt(dr.Item("unit_base_id"))
            'Me.bus_unit = DBtoStr(dr.Item("bus_unit"))
            'Me.structure_id = DBtoStr(dr.Item("structure_id"))
            Me.pier_shape = DBtoStr(dr.Item("pier_shape"))
            Me.pier_diameter = DBtoNullableDbl(dr.Item("pier_diameter"))
        ...
        If excelDS.Tables.Contains("Unit Base General Results EXCEL") Then

            For Each Row As DataRow In excelDS.Tables("Unit Base General Results EXCEL").Rows
...
#Region "Save to EDS"
    ...
    Public Overrides Function SQLInsertValues() As String
        ...
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.tower_centroid_offset.NullableToString.FormatDBValue)
    ...
    Public Overrides Function SQLUpdateFieldsandValues() As String
        ...
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("tower_centroid_offset = " & Me.tower_centroid_offset.NullableToString.FormatDBValue)
