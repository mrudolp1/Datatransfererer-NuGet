...
#Region "Inherits"
    ...
    Public Overrides Function SQLInsertValues() As String
        SQLInsertValues = ""
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.File.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.USName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.SIName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Values.ToString.FormatDBValue)
...
#Region "Inherits"
    ...
    Public Overrides Function SQLInsertValues() As String
        SQLInsertValues = ""
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.IsBolt.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MemberMatFile.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MatName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MatValues.ToString.FormatDBValue)
        Return SQLInsertValues
    End Function
    Public Overrides Function SQLInsertFields() As String
        SQLInsertFields = ""
...
'    Public Overrides Function SQLInsert() As String
'        Return Me.SQLInsert(True)
'    End Function
'    Public Overloads Function SQLInsert(Optional ByVal ParentIDKnown As Boolean = True) As String

'        SQLInsert =
'            "BEGIN" & vbCrLf &
'            "   Select Case Top 1 @SubLevel1ID = tbl.ID" & vbCrLf &
'            "   From tnx.materials tbl" & vbCrLf &
'            "   Where tbl.IsBolt = True" & vbCrLf &
'            "   And tbl.MemberMatFile = " & Me.BoltMatFile.ToString.FormatDBValue & vbCrLf &
'            "   And tbl.MatName = " & Me.MatName.ToString.FormatDBValue & vbCrLf &
'            "   And tbl.MatValues = " & Me.MatValues.ToString.FormatDBValue & vbCrLf &
'            "   If @SubLevel1ID Is NULL" & vbCrLf &
'            "       BEGIN" & vbCrLf &
'            "           Insert INTO tnx.materials OUTPUT INSERTED.ID INTO @TopLevel VALUES([VALUES])" & vbCrLf &
'            "           Select Case Case@SubLevel1ID = ID FROM @SubLevel1" & vbCrLf &
'            "       End" & vbCrLf &
'            "Insert INTO tnx.materials_xref VALUES(@SubLevel1ID," & If(ParentIDKnown, Me.ParentStructure.tnx.ID.ToString.FormatDBValue, "@TopLevelID") & ")" & vbCrLf &
'            "Delete FROM @SubLevel1" & vbCrLf &
'            "Set @SubLevel1ID = NULL" & vbCrLf &
'            "END"
...
'    Public Overrides Function SQLInsertValues() As String
'        SQLInsertValues = ""
'        SQLInsertValues = SQLInsertValues.AddtoDBString("True".FormatDBValue)
'        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.BoltMatFile.ToString.FormatDBValue)
'        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MatName.ToString.FormatDBValue)
'        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MatValues.ToString.FormatDBValue)
'        Return SQLInsertValues
'    End Function
...
'    'Public Overrides Function SQLUpdateFieldsandValues() As String
'    '    SQLUpdateFieldsandValues = ""
'    '    SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IsBolt = True")
'    '    SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("MemberMatFile = " & Me.BoltMatFile.ToString.FormatDBValue)
'    '    SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("MatName = " & Me.MatName.ToString.FormatDBValue)
'    '    SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("MatValues = " & Me.MatValues.ToString.FormatDBValue)
'    '    Return SQLUpdateFieldsandValues
'    'End Function
...
'    <Category("TNX Material Properties"), Description(""), DisplayName("Bolt Type")>
...
'        'Makes sure you are comparing to the same object type
'        'Customize this to the object type
'        Dim otherToCompare As tnxBolt = TryCast(other, tnxBolt)
'        If otherToCompare Is Nothing Then Return False

'        Equals = If(Me.BoltMatFile.CheckChange(otherToCompare.BoltMatFile, changes, categoryName, "Bolt type"), Equals, False)
'        Equals = If(Me.MatName.CheckChange(otherToCompare.MatName, changes, categoryName, "Bolt name"), Equals, False)
'        Equals = If(Me.MatValues.CheckChange(otherToCompare.MatValues, changes, categoryName, "Bolt properties"), Equals, False)
...
#Region "Inheritted"
    ...
    Public Overloads Function SQLInsertValues(Optional ByVal ParentID As Integer? = Nothing) As String
        ...
        SQLInsertValues = SQLInsertValues.AddtoDBString(If(ParentID Is Nothing, "@TopLevelID", ParentID.ToString.FormatDBValue))
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Rec.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBraceType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHeight.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalSpacing.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalSpacingEx.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaNumSections.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaNumSesctions.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaSectionLength.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerBracingGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerBracingMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLongHorizontalGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLongHorizontalMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerBracingType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerBracingSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtOffset.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtOffset.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHasKBraceEndPanels.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHasHorizontals.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLongHorizontalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLongHorizontalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalSize2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalSize3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalSize4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalSize2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalSize3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalSize4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaSubDiagLocation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalSize2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalSize3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalSize4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipSize2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipSize3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipSize4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaNumInnerGirts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaPoleShapeType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaPoleSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaPoleGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaPoleMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaPoleSpliceLength.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleNumSides.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleTopDiameter.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleBotDiameter.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleWallThickness.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleBendRadius.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTaperPoleMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaSWMult.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaWPMult.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaAutoCalcKSingleAngle.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaAutoCalcKSolidRound.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaAfGusset.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTfGusset.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaGussetBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaGussetGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaGussetMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaAfMult.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaArMult.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaFlatIPAPole.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRoundIPAPole.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaFlatIPALeg.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRoundIPALeg.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaFlatIPAHorizontal.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRoundIPAHorizontal.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaFlatIPADiagonal.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRoundIPADiagonal.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaCSA_S37_SpeedUpFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKLegs.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKXBracedDiags.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKKBracedDiags.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKZBracedDiags.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKHorzs.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKSecHorzs.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKGirts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKInners.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKXBracedDiagsY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKKBracedDiagsY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKZBracedDiagsY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKHorzsY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKSecHorzsY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKGirtsY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKInnersY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedHorz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedDiag.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedSubDiag.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedSubHorz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedVert.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedHip.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKRedHipDiag.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKTLX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKTLZ.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKTLLeg.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerKTLX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerKTLZ.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerKTLLeg.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaStitchBoltLocationHoriz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaStitchBoltLocationDiag.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaStitchSpacing.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaStitchSpacingHorz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaStitchSpacingDiag.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaStitchSpacingRed.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegConnType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaLegBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBotGirtGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaInnerGirtGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaShortHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHorizontalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantDiagonalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubDiagonalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantSubHorizontalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantVerticalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaRedundantHipDiagonalUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagonalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaTopGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaBottomGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaMidGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaHorizontalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaSecondaryHorizontalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagOffsetNEY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagOffsetNEX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagOffsetPEY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaDiagOffsetPEX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKbraceOffsetNEY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKbraceOffsetNEX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKbraceOffsetPEY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.AntennaKbraceOffsetPEX.ToString.FormatDBValue)
    ...
    Public Overrides Function SQLUpdateFieldsandValues() As String
        ...
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRec = " & Me.Rec.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBraceType = " & Me.AntennaBraceType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHeight = " & Me.AntennaHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalSpacing = " & Me.AntennaDiagonalSpacing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalSpacingEx = " & Me.AntennaDiagonalSpacingEx.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaNumSections = " & Me.AntennaNumSections.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaNumSesctions = " & Me.AntennaNumSesctions.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaSectionLength = " & Me.AntennaSectionLength.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegType = " & Me.AntennaLegType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegSize = " & Me.AntennaLegSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegGrade = " & Me.AntennaLegGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegMatlGrade = " & Me.AntennaLegMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalGrade = " & Me.AntennaDiagonalGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalMatlGrade = " & Me.AntennaDiagonalMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerBracingGrade = " & Me.AntennaInnerBracingGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerBracingMatlGrade = " & Me.AntennaInnerBracingMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtGrade = " & Me.AntennaTopGirtGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtMatlGrade = " & Me.AntennaTopGirtMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtGrade = " & Me.AntennaBotGirtGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtMatlGrade = " & Me.AntennaBotGirtMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtGrade = " & Me.AntennaInnerGirtGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtMatlGrade = " & Me.AntennaInnerGirtMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLongHorizontalGrade = " & Me.AntennaLongHorizontalGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLongHorizontalMatlGrade = " & Me.AntennaLongHorizontalMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalGrade = " & Me.AntennaShortHorizontalGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalMatlGrade = " & Me.AntennaShortHorizontalMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalType = " & Me.AntennaDiagonalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalSize = " & Me.AntennaDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerBracingType = " & Me.AntennaInnerBracingType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerBracingSize = " & Me.AntennaInnerBracingSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtType = " & Me.AntennaTopGirtType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtSize = " & Me.AntennaTopGirtSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtType = " & Me.AntennaBotGirtType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtSize = " & Me.AntennaBotGirtSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtOffset = " & Me.AntennaTopGirtOffset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtOffset = " & Me.AntennaBotGirtOffset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHasKBraceEndPanels = " & Me.AntennaHasKBraceEndPanels.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHasHorizontals = " & Me.AntennaHasHorizontals.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLongHorizontalType = " & Me.AntennaLongHorizontalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLongHorizontalSize = " & Me.AntennaLongHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalType = " & Me.AntennaShortHorizontalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalSize = " & Me.AntennaShortHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantGrade = " & Me.AntennaRedundantGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantMatlGrade = " & Me.AntennaRedundantMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantType = " & Me.AntennaRedundantType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagType = " & Me.AntennaRedundantDiagType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalType = " & Me.AntennaRedundantSubDiagonalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalType = " & Me.AntennaRedundantSubHorizontalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalType = " & Me.AntennaRedundantVerticalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipType = " & Me.AntennaRedundantHipType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalType = " & Me.AntennaRedundantHipDiagonalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalSize = " & Me.AntennaRedundantHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalSize2 = " & Me.AntennaRedundantHorizontalSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalSize3 = " & Me.AntennaRedundantHorizontalSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalSize4 = " & Me.AntennaRedundantHorizontalSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalSize = " & Me.AntennaRedundantDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalSize2 = " & Me.AntennaRedundantDiagonalSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalSize3 = " & Me.AntennaRedundantDiagonalSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalSize4 = " & Me.AntennaRedundantDiagonalSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalSize = " & Me.AntennaRedundantSubHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalSize = " & Me.AntennaRedundantSubDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaSubDiagLocation = " & Me.AntennaSubDiagLocation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalSize = " & Me.AntennaRedundantVerticalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalSize = " & Me.AntennaRedundantHipDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalSize2 = " & Me.AntennaRedundantHipDiagonalSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalSize3 = " & Me.AntennaRedundantHipDiagonalSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalSize4 = " & Me.AntennaRedundantHipDiagonalSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipSize = " & Me.AntennaRedundantHipSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipSize2 = " & Me.AntennaRedundantHipSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipSize3 = " & Me.AntennaRedundantHipSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipSize4 = " & Me.AntennaRedundantHipSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaNumInnerGirts = " & Me.AntennaNumInnerGirts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtType = " & Me.AntennaInnerGirtType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtSize = " & Me.AntennaInnerGirtSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaPoleShapeType = " & Me.AntennaPoleShapeType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaPoleSize = " & Me.AntennaPoleSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaPoleGrade = " & Me.AntennaPoleGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaPoleMatlGrade = " & Me.AntennaPoleMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaPoleSpliceLength = " & Me.AntennaPoleSpliceLength.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleNumSides = " & Me.AntennaTaperPoleNumSides.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleTopDiameter = " & Me.AntennaTaperPoleTopDiameter.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleBotDiameter = " & Me.AntennaTaperPoleBotDiameter.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleWallThickness = " & Me.AntennaTaperPoleWallThickness.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleBendRadius = " & Me.AntennaTaperPoleBendRadius.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleGrade = " & Me.AntennaTaperPoleGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTaperPoleMatlGrade = " & Me.AntennaTaperPoleMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaSWMult = " & Me.AntennaSWMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaWPMult = " & Me.AntennaWPMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaAutoCalcKSingleAngle = " & Me.AntennaAutoCalcKSingleAngle.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaAutoCalcKSolidRound = " & Me.AntennaAutoCalcKSolidRound.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaAfGusset = " & Me.AntennaAfGusset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTfGusset = " & Me.AntennaTfGusset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaGussetBoltEdgeDistance = " & Me.AntennaGussetBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaGussetGrade = " & Me.AntennaGussetGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaGussetMatlGrade = " & Me.AntennaGussetMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaAfMult = " & Me.AntennaAfMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaArMult = " & Me.AntennaArMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaFlatIPAPole = " & Me.AntennaFlatIPAPole.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRoundIPAPole = " & Me.AntennaRoundIPAPole.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaFlatIPALeg = " & Me.AntennaFlatIPALeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRoundIPALeg = " & Me.AntennaRoundIPALeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaFlatIPAHorizontal = " & Me.AntennaFlatIPAHorizontal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRoundIPAHorizontal = " & Me.AntennaRoundIPAHorizontal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaFlatIPADiagonal = " & Me.AntennaFlatIPADiagonal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRoundIPADiagonal = " & Me.AntennaRoundIPADiagonal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaCSA_S37_SpeedUpFactor = " & Me.AntennaCSA_S37_SpeedUpFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKLegs = " & Me.AntennaKLegs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKXBracedDiags = " & Me.AntennaKXBracedDiags.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKKBracedDiags = " & Me.AntennaKKBracedDiags.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKZBracedDiags = " & Me.AntennaKZBracedDiags.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKHorzs = " & Me.AntennaKHorzs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKSecHorzs = " & Me.AntennaKSecHorzs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKGirts = " & Me.AntennaKGirts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKInners = " & Me.AntennaKInners.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKXBracedDiagsY = " & Me.AntennaKXBracedDiagsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKKBracedDiagsY = " & Me.AntennaKKBracedDiagsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKZBracedDiagsY = " & Me.AntennaKZBracedDiagsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKHorzsY = " & Me.AntennaKHorzsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKSecHorzsY = " & Me.AntennaKSecHorzsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKGirtsY = " & Me.AntennaKGirtsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKInnersY = " & Me.AntennaKInnersY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedHorz = " & Me.AntennaKRedHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedDiag = " & Me.AntennaKRedDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedSubDiag = " & Me.AntennaKRedSubDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedSubHorz = " & Me.AntennaKRedSubHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedVert = " & Me.AntennaKRedVert.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedHip = " & Me.AntennaKRedHip.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKRedHipDiag = " & Me.AntennaKRedHipDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKTLX = " & Me.AntennaKTLX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKTLZ = " & Me.AntennaKTLZ.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKTLLeg = " & Me.AntennaKTLLeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerKTLX = " & Me.AntennaInnerKTLX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerKTLZ = " & Me.AntennaInnerKTLZ.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerKTLLeg = " & Me.AntennaInnerKTLLeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaStitchBoltLocationHoriz = " & Me.AntennaStitchBoltLocationHoriz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaStitchBoltLocationDiag = " & Me.AntennaStitchBoltLocationDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaStitchSpacing = " & Me.AntennaStitchSpacing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaStitchSpacingHorz = " & Me.AntennaStitchSpacingHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaStitchSpacingDiag = " & Me.AntennaStitchSpacingDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaStitchSpacingRed = " & Me.AntennaStitchSpacingRed.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegNetWidthDeduct = " & Me.AntennaLegNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegUFactor = " & Me.AntennaLegUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalNetWidthDeduct = " & Me.AntennaDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtNetWidthDeduct = " & Me.AntennaTopGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtNetWidthDeduct = " & Me.AntennaBotGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtNetWidthDeduct = " & Me.AntennaInnerGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalNetWidthDeduct = " & Me.AntennaHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalNetWidthDeduct = " & Me.AntennaShortHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalUFactor = " & Me.AntennaDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtUFactor = " & Me.AntennaTopGirtUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtUFactor = " & Me.AntennaBotGirtUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtUFactor = " & Me.AntennaInnerGirtUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalUFactor = " & Me.AntennaHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalUFactor = " & Me.AntennaShortHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegConnType = " & Me.AntennaLegConnType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegNumBolts = " & Me.AntennaLegNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalNumBolts = " & Me.AntennaDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtNumBolts = " & Me.AntennaTopGirtNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtNumBolts = " & Me.AntennaBotGirtNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtNumBolts = " & Me.AntennaInnerGirtNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalNumBolts = " & Me.AntennaHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalNumBolts = " & Me.AntennaShortHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegBoltGrade = " & Me.AntennaLegBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegBoltSize = " & Me.AntennaLegBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalBoltGrade = " & Me.AntennaDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalBoltSize = " & Me.AntennaDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtBoltGrade = " & Me.AntennaTopGirtBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtBoltSize = " & Me.AntennaTopGirtBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtBoltGrade = " & Me.AntennaBotGirtBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtBoltSize = " & Me.AntennaBotGirtBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtBoltGrade = " & Me.AntennaInnerGirtBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtBoltSize = " & Me.AntennaInnerGirtBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalBoltGrade = " & Me.AntennaHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalBoltSize = " & Me.AntennaHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalBoltGrade = " & Me.AntennaShortHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalBoltSize = " & Me.AntennaShortHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaLegBoltEdgeDistance = " & Me.AntennaLegBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalBoltEdgeDistance = " & Me.AntennaDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtBoltEdgeDistance = " & Me.AntennaTopGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtBoltEdgeDistance = " & Me.AntennaBotGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtBoltEdgeDistance = " & Me.AntennaInnerGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalBoltEdgeDistance = " & Me.AntennaHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalBoltEdgeDistance = " & Me.AntennaShortHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalGageG1Distance = " & Me.AntennaDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtGageG1Distance = " & Me.AntennaTopGirtGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBotGirtGageG1Distance = " & Me.AntennaBotGirtGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaInnerGirtGageG1Distance = " & Me.AntennaInnerGirtGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalGageG1Distance = " & Me.AntennaHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaShortHorizontalGageG1Distance = " & Me.AntennaShortHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalBoltGrade = " & Me.AntennaRedundantHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalBoltSize = " & Me.AntennaRedundantHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalNumBolts = " & Me.AntennaRedundantHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalBoltEdgeDistance = " & Me.AntennaRedundantHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalGageG1Distance = " & Me.AntennaRedundantHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalNetWidthDeduct = " & Me.AntennaRedundantHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHorizontalUFactor = " & Me.AntennaRedundantHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalBoltGrade = " & Me.AntennaRedundantDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalBoltSize = " & Me.AntennaRedundantDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalNumBolts = " & Me.AntennaRedundantDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalBoltEdgeDistance = " & Me.AntennaRedundantDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalGageG1Distance = " & Me.AntennaRedundantDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalNetWidthDeduct = " & Me.AntennaRedundantDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantDiagonalUFactor = " & Me.AntennaRedundantDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalBoltGrade = " & Me.AntennaRedundantSubDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalBoltSize = " & Me.AntennaRedundantSubDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalNumBolts = " & Me.AntennaRedundantSubDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalBoltEdgeDistance = " & Me.AntennaRedundantSubDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalGageG1Distance = " & Me.AntennaRedundantSubDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalNetWidthDeduct = " & Me.AntennaRedundantSubDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubDiagonalUFactor = " & Me.AntennaRedundantSubDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalBoltGrade = " & Me.AntennaRedundantSubHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalBoltSize = " & Me.AntennaRedundantSubHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalNumBolts = " & Me.AntennaRedundantSubHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalBoltEdgeDistance = " & Me.AntennaRedundantSubHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalGageG1Distance = " & Me.AntennaRedundantSubHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalNetWidthDeduct = " & Me.AntennaRedundantSubHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantSubHorizontalUFactor = " & Me.AntennaRedundantSubHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalBoltGrade = " & Me.AntennaRedundantVerticalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalBoltSize = " & Me.AntennaRedundantVerticalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalNumBolts = " & Me.AntennaRedundantVerticalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalBoltEdgeDistance = " & Me.AntennaRedundantVerticalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalGageG1Distance = " & Me.AntennaRedundantVerticalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalNetWidthDeduct = " & Me.AntennaRedundantVerticalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantVerticalUFactor = " & Me.AntennaRedundantVerticalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipBoltGrade = " & Me.AntennaRedundantHipBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipBoltSize = " & Me.AntennaRedundantHipBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipNumBolts = " & Me.AntennaRedundantHipNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipBoltEdgeDistance = " & Me.AntennaRedundantHipBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipGageG1Distance = " & Me.AntennaRedundantHipGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipNetWidthDeduct = " & Me.AntennaRedundantHipNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipUFactor = " & Me.AntennaRedundantHipUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalBoltGrade = " & Me.AntennaRedundantHipDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalBoltSize = " & Me.AntennaRedundantHipDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalNumBolts = " & Me.AntennaRedundantHipDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalBoltEdgeDistance = " & Me.AntennaRedundantHipDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalGageG1Distance = " & Me.AntennaRedundantHipDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalNetWidthDeduct = " & Me.AntennaRedundantHipDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaRedundantHipDiagonalUFactor = " & Me.AntennaRedundantHipDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagonalOutOfPlaneRestraint = " & Me.AntennaDiagonalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaTopGirtOutOfPlaneRestraint = " & Me.AntennaTopGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaBottomGirtOutOfPlaneRestraint = " & Me.AntennaBottomGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaMidGirtOutOfPlaneRestraint = " & Me.AntennaMidGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaHorizontalOutOfPlaneRestraint = " & Me.AntennaHorizontalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaSecondaryHorizontalOutOfPlaneRestraint = " & Me.AntennaSecondaryHorizontalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagOffsetNEY = " & Me.AntennaDiagOffsetNEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagOffsetNEX = " & Me.AntennaDiagOffsetNEX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagOffsetPEY = " & Me.AntennaDiagOffsetPEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaDiagOffsetPEX = " & Me.AntennaDiagOffsetPEX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKbraceOffsetNEY = " & Me.AntennaKbraceOffsetNEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKbraceOffsetNEX = " & Me.AntennaKbraceOffsetNEX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKbraceOffsetPEY = " & Me.AntennaKbraceOffsetPEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaKbraceOffsetPEX = " & Me.AntennaKbraceOffsetPEX.ToString.FormatDBValue)
...
#Region "Inheritted"
    ...
    Public Overrides Function SQLUpdateFieldsandValues() As String
        ...
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRec = " & Me.Rec.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDatabase = " & Me.TowerDatabase.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerName = " & Me.TowerName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHeight = " & Me.TowerHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerFaceWidth = " & Me.TowerFaceWidth.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerNumSections = " & Me.TowerNumSections.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerSectionLength = " & Me.TowerSectionLength.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalSpacing = " & Me.TowerDiagonalSpacing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalSpacingEx = " & Me.TowerDiagonalSpacingEx.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBraceType = " & Me.TowerBraceType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerFaceBevel = " & Me.TowerFaceBevel.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtOffset = " & Me.TowerTopGirtOffset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtOffset = " & Me.TowerBotGirtOffset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHasKBraceEndPanels = " & Me.TowerHasKBraceEndPanels.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHasHorizontals = " & Me.TowerHasHorizontals.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegType = " & Me.TowerLegType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegSize = " & Me.TowerLegSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegGrade = " & Me.TowerLegGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegMatlGrade = " & Me.TowerLegMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalGrade = " & Me.TowerDiagonalGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalMatlGrade = " & Me.TowerDiagonalMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerBracingGrade = " & Me.TowerInnerBracingGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerBracingMatlGrade = " & Me.TowerInnerBracingMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtGrade = " & Me.TowerTopGirtGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtMatlGrade = " & Me.TowerTopGirtMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtGrade = " & Me.TowerBotGirtGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtMatlGrade = " & Me.TowerBotGirtMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtGrade = " & Me.TowerInnerGirtGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtMatlGrade = " & Me.TowerInnerGirtMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLongHorizontalGrade = " & Me.TowerLongHorizontalGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLongHorizontalMatlGrade = " & Me.TowerLongHorizontalMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalGrade = " & Me.TowerShortHorizontalGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalMatlGrade = " & Me.TowerShortHorizontalMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalType = " & Me.TowerDiagonalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalSize = " & Me.TowerDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerBracingType = " & Me.TowerInnerBracingType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerBracingSize = " & Me.TowerInnerBracingSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtType = " & Me.TowerTopGirtType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtSize = " & Me.TowerTopGirtSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtType = " & Me.TowerBotGirtType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtSize = " & Me.TowerBotGirtSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerNumInnerGirts = " & Me.TowerNumInnerGirts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtType = " & Me.TowerInnerGirtType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtSize = " & Me.TowerInnerGirtSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLongHorizontalType = " & Me.TowerLongHorizontalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLongHorizontalSize = " & Me.TowerLongHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalType = " & Me.TowerShortHorizontalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalSize = " & Me.TowerShortHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantGrade = " & Me.TowerRedundantGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantMatlGrade = " & Me.TowerRedundantMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantType = " & Me.TowerRedundantType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagType = " & Me.TowerRedundantDiagType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalType = " & Me.TowerRedundantSubDiagonalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalType = " & Me.TowerRedundantSubHorizontalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalType = " & Me.TowerRedundantVerticalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipType = " & Me.TowerRedundantHipType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalType = " & Me.TowerRedundantHipDiagonalType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalSize = " & Me.TowerRedundantHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalSize2 = " & Me.TowerRedundantHorizontalSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalSize3 = " & Me.TowerRedundantHorizontalSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalSize4 = " & Me.TowerRedundantHorizontalSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalSize = " & Me.TowerRedundantDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalSize2 = " & Me.TowerRedundantDiagonalSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalSize3 = " & Me.TowerRedundantDiagonalSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalSize4 = " & Me.TowerRedundantDiagonalSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalSize = " & Me.TowerRedundantSubHorizontalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalSize = " & Me.TowerRedundantSubDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerSubDiagLocation = " & Me.TowerSubDiagLocation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalSize = " & Me.TowerRedundantVerticalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipSize = " & Me.TowerRedundantHipSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipSize2 = " & Me.TowerRedundantHipSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipSize3 = " & Me.TowerRedundantHipSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipSize4 = " & Me.TowerRedundantHipSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalSize = " & Me.TowerRedundantHipDiagonalSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalSize2 = " & Me.TowerRedundantHipDiagonalSize2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalSize3 = " & Me.TowerRedundantHipDiagonalSize3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalSize4 = " & Me.TowerRedundantHipDiagonalSize4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerSWMult = " & Me.TowerSWMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerWPMult = " & Me.TowerWPMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerAutoCalcKSingleAngle = " & Me.TowerAutoCalcKSingleAngle.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerAutoCalcKSolidRound = " & Me.TowerAutoCalcKSolidRound.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerAfGusset = " & Me.TowerAfGusset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTfGusset = " & Me.TowerTfGusset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerGussetBoltEdgeDistance = " & Me.TowerGussetBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerGussetGrade = " & Me.TowerGussetGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerGussetMatlGrade = " & Me.TowerGussetMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerAfMult = " & Me.TowerAfMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerArMult = " & Me.TowerArMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerFlatIPAPole = " & Me.TowerFlatIPAPole.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRoundIPAPole = " & Me.TowerRoundIPAPole.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerFlatIPALeg = " & Me.TowerFlatIPALeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRoundIPALeg = " & Me.TowerRoundIPALeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerFlatIPAHorizontal = " & Me.TowerFlatIPAHorizontal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRoundIPAHorizontal = " & Me.TowerRoundIPAHorizontal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerFlatIPADiagonal = " & Me.TowerFlatIPADiagonal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRoundIPADiagonal = " & Me.TowerRoundIPADiagonal.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerCSA_S37_SpeedUpFactor = " & Me.TowerCSA_S37_SpeedUpFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKLegs = " & Me.TowerKLegs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKXBracedDiags = " & Me.TowerKXBracedDiags.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKKBracedDiags = " & Me.TowerKKBracedDiags.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKZBracedDiags = " & Me.TowerKZBracedDiags.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKHorzs = " & Me.TowerKHorzs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKSecHorzs = " & Me.TowerKSecHorzs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKGirts = " & Me.TowerKGirts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKInners = " & Me.TowerKInners.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKXBracedDiagsY = " & Me.TowerKXBracedDiagsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKKBracedDiagsY = " & Me.TowerKKBracedDiagsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKZBracedDiagsY = " & Me.TowerKZBracedDiagsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKHorzsY = " & Me.TowerKHorzsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKSecHorzsY = " & Me.TowerKSecHorzsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKGirtsY = " & Me.TowerKGirtsY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKInnersY = " & Me.TowerKInnersY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedHorz = " & Me.TowerKRedHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedDiag = " & Me.TowerKRedDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedSubDiag = " & Me.TowerKRedSubDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedSubHorz = " & Me.TowerKRedSubHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedVert = " & Me.TowerKRedVert.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedHip = " & Me.TowerKRedHip.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKRedHipDiag = " & Me.TowerKRedHipDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKTLX = " & Me.TowerKTLX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKTLZ = " & Me.TowerKTLZ.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKTLLeg = " & Me.TowerKTLLeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerKTLX = " & Me.TowerInnerKTLX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerKTLZ = " & Me.TowerInnerKTLZ.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerKTLLeg = " & Me.TowerInnerKTLLeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchBoltLocationHoriz = " & Me.TowerStitchBoltLocationHoriz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchBoltLocationDiag = " & Me.TowerStitchBoltLocationDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchBoltLocationRed = " & Me.TowerStitchBoltLocationRed.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchSpacing = " & Me.TowerStitchSpacing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchSpacingDiag = " & Me.TowerStitchSpacingDiag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchSpacingHorz = " & Me.TowerStitchSpacingHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerStitchSpacingRed = " & Me.TowerStitchSpacingRed.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegNetWidthDeduct = " & Me.TowerLegNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegUFactor = " & Me.TowerLegUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalNetWidthDeduct = " & Me.TowerDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtNetWidthDeduct = " & Me.TowerTopGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtNetWidthDeduct = " & Me.TowerBotGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtNetWidthDeduct = " & Me.TowerInnerGirtNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalNetWidthDeduct = " & Me.TowerHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalNetWidthDeduct = " & Me.TowerShortHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalUFactor = " & Me.TowerDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtUFactor = " & Me.TowerTopGirtUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtUFactor = " & Me.TowerBotGirtUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtUFactor = " & Me.TowerInnerGirtUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalUFactor = " & Me.TowerHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalUFactor = " & Me.TowerShortHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegConnType = " & Me.TowerLegConnType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegNumBolts = " & Me.TowerLegNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalNumBolts = " & Me.TowerDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtNumBolts = " & Me.TowerTopGirtNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtNumBolts = " & Me.TowerBotGirtNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtNumBolts = " & Me.TowerInnerGirtNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalNumBolts = " & Me.TowerHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalNumBolts = " & Me.TowerShortHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegBoltGrade = " & Me.TowerLegBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegBoltSize = " & Me.TowerLegBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalBoltGrade = " & Me.TowerDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalBoltSize = " & Me.TowerDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtBoltGrade = " & Me.TowerTopGirtBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtBoltSize = " & Me.TowerTopGirtBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtBoltGrade = " & Me.TowerBotGirtBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtBoltSize = " & Me.TowerBotGirtBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtBoltGrade = " & Me.TowerInnerGirtBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtBoltSize = " & Me.TowerInnerGirtBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalBoltGrade = " & Me.TowerHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalBoltSize = " & Me.TowerHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalBoltGrade = " & Me.TowerShortHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalBoltSize = " & Me.TowerShortHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerLegBoltEdgeDistance = " & Me.TowerLegBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalBoltEdgeDistance = " & Me.TowerDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtBoltEdgeDistance = " & Me.TowerTopGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtBoltEdgeDistance = " & Me.TowerBotGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtBoltEdgeDistance = " & Me.TowerInnerGirtBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalBoltEdgeDistance = " & Me.TowerHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalBoltEdgeDistance = " & Me.TowerShortHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalGageG1Distance = " & Me.TowerDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtGageG1Distance = " & Me.TowerTopGirtGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBotGirtGageG1Distance = " & Me.TowerBotGirtGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerInnerGirtGageG1Distance = " & Me.TowerInnerGirtGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalGageG1Distance = " & Me.TowerHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerShortHorizontalGageG1Distance = " & Me.TowerShortHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalBoltGrade = " & Me.TowerRedundantHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalBoltSize = " & Me.TowerRedundantHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalNumBolts = " & Me.TowerRedundantHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalBoltEdgeDistance = " & Me.TowerRedundantHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalGageG1Distance = " & Me.TowerRedundantHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalNetWidthDeduct = " & Me.TowerRedundantHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHorizontalUFactor = " & Me.TowerRedundantHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalBoltGrade = " & Me.TowerRedundantDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalBoltSize = " & Me.TowerRedundantDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalNumBolts = " & Me.TowerRedundantDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalBoltEdgeDistance = " & Me.TowerRedundantDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalGageG1Distance = " & Me.TowerRedundantDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalNetWidthDeduct = " & Me.TowerRedundantDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantDiagonalUFactor = " & Me.TowerRedundantDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalBoltGrade = " & Me.TowerRedundantSubDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalBoltSize = " & Me.TowerRedundantSubDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalNumBolts = " & Me.TowerRedundantSubDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalBoltEdgeDistance = " & Me.TowerRedundantSubDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalGageG1Distance = " & Me.TowerRedundantSubDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalNetWidthDeduct = " & Me.TowerRedundantSubDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubDiagonalUFactor = " & Me.TowerRedundantSubDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalBoltGrade = " & Me.TowerRedundantSubHorizontalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalBoltSize = " & Me.TowerRedundantSubHorizontalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalNumBolts = " & Me.TowerRedundantSubHorizontalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalBoltEdgeDistance = " & Me.TowerRedundantSubHorizontalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalGageG1Distance = " & Me.TowerRedundantSubHorizontalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalNetWidthDeduct = " & Me.TowerRedundantSubHorizontalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantSubHorizontalUFactor = " & Me.TowerRedundantSubHorizontalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalBoltGrade = " & Me.TowerRedundantVerticalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalBoltSize = " & Me.TowerRedundantVerticalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalNumBolts = " & Me.TowerRedundantVerticalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalBoltEdgeDistance = " & Me.TowerRedundantVerticalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalGageG1Distance = " & Me.TowerRedundantVerticalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalNetWidthDeduct = " & Me.TowerRedundantVerticalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantVerticalUFactor = " & Me.TowerRedundantVerticalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipBoltGrade = " & Me.TowerRedundantHipBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipBoltSize = " & Me.TowerRedundantHipBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipNumBolts = " & Me.TowerRedundantHipNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipBoltEdgeDistance = " & Me.TowerRedundantHipBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipGageG1Distance = " & Me.TowerRedundantHipGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipNetWidthDeduct = " & Me.TowerRedundantHipNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipUFactor = " & Me.TowerRedundantHipUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalBoltGrade = " & Me.TowerRedundantHipDiagonalBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalBoltSize = " & Me.TowerRedundantHipDiagonalBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalNumBolts = " & Me.TowerRedundantHipDiagonalNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalBoltEdgeDistance = " & Me.TowerRedundantHipDiagonalBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalGageG1Distance = " & Me.TowerRedundantHipDiagonalGageG1Distance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalNetWidthDeduct = " & Me.TowerRedundantHipDiagonalNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerRedundantHipDiagonalUFactor = " & Me.TowerRedundantHipDiagonalUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagonalOutOfPlaneRestraint = " & Me.TowerDiagonalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopGirtOutOfPlaneRestraint = " & Me.TowerTopGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBottomGirtOutOfPlaneRestraint = " & Me.TowerBottomGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerMidGirtOutOfPlaneRestraint = " & Me.TowerMidGirtOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerHorizontalOutOfPlaneRestraint = " & Me.TowerHorizontalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerSecondaryHorizontalOutOfPlaneRestraint = " & Me.TowerSecondaryHorizontalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerUniqueFlag = " & Me.TowerUniqueFlag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagOffsetNEY = " & Me.TowerDiagOffsetNEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagOffsetNEX = " & Me.TowerDiagOffsetNEX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagOffsetPEY = " & Me.TowerDiagOffsetPEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerDiagOffsetPEX = " & Me.TowerDiagOffsetPEX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKbraceOffsetNEY = " & Me.TowerKbraceOffsetNEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKbraceOffsetNEX = " & Me.TowerKbraceOffsetNEX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKbraceOffsetPEY = " & Me.TowerKbraceOffsetPEY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerKbraceOffsetPEX = " & Me.TowerKbraceOffsetPEX.ToString.FormatDBValue)
...
#Region "Inheritted"
    ...
    Public Overloads Function SQLInsertValues(Optional ByVal ParentIDKnown As Boolean = True) As String
        ...
        SQLInsertValues = SQLInsertValues.AddtoDBString(If(ParentIDKnown, Me.Parent.ID.ToString.FormatDBValue, "@TopLevelID"))
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Rec.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyHeight.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyAutoCalcKSingleAngle.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyAutoCalcKSolidRound.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyMount.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmStyle.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyRadius.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyRadius120.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyRadius240.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyRadius360.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmRadius.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmLegAngle.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Azimuth0Adjustment.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Azimuth120Adjustment.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Azimuth240Adjustment.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Azimuth360Adjustment.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Anchor0Elevation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Anchor120Elevation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Anchor240Elevation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Anchor360Elevation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuySize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Guy120Size.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Guy240Size.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.Guy360Size.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmSizeBot.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmKFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.TorqueArmKFactorY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffKFactorX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffKFactorY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagKFactorX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagKFactorY.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyAutoCalc.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyAllGuysSame.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyAllGuysAnchorSame.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyIsStrapping.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffSizeBot.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyUpperDiagSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyLowerDiagSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagMatlGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagonalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyDiagBoltGageDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPullOffBoltGageDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmNetWidthDeduct.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmUFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmNumBolts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmBoltSize.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmBoltEdgeDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyTorqueArmBoltGageDistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPerCentTension.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPerCentTension120.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPerCentTension240.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyPerCentTension360.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyEffFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyEffFactor120.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyEffFactor240.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyEffFactor360.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyNumInsulators.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyInsulatorLength.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyInsulatorDia.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.GuyInsulatorWt.ToString.FormatDBValue)
    ...
    Public Overrides Function SQLUpdateFieldsandValues() As String
        ...
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyRec = " & Me.Rec.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyHeight = " & Me.GuyHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyAutoCalcKSingleAngle = " & Me.GuyAutoCalcKSingleAngle.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyAutoCalcKSolidRound = " & Me.GuyAutoCalcKSolidRound.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyMount = " & Me.GuyMount.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmStyle = " & Me.TorqueArmStyle.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyRadius = " & Me.GuyRadius.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyRadius120 = " & Me.GuyRadius120.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyRadius240 = " & Me.GuyRadius240.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyRadius360 = " & Me.GuyRadius360.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmRadius = " & Me.TorqueArmRadius.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmLegAngle = " & Me.TorqueArmLegAngle.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Azimuth0Adjustment = " & Me.Azimuth0Adjustment.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Azimuth120Adjustment = " & Me.Azimuth120Adjustment.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Azimuth240Adjustment = " & Me.Azimuth240Adjustment.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Azimuth360Adjustment = " & Me.Azimuth360Adjustment.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Anchor0Elevation = " & Me.Anchor0Elevation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Anchor120Elevation = " & Me.Anchor120Elevation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Anchor240Elevation = " & Me.Anchor240Elevation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Anchor360Elevation = " & Me.Anchor360Elevation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuySize = " & Me.GuySize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Guy120Size = " & Me.Guy120Size.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Guy240Size = " & Me.Guy240Size.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Guy360Size = " & Me.Guy360Size.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyGrade = " & Me.GuyGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmSize = " & Me.TorqueArmSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmSizeBot = " & Me.TorqueArmSizeBot.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmType = " & Me.TorqueArmType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmGrade = " & Me.TorqueArmGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmMatlGrade = " & Me.TorqueArmMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmKFactor = " & Me.TorqueArmKFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TorqueArmKFactorY = " & Me.TorqueArmKFactorY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffKFactorX = " & Me.GuyPullOffKFactorX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffKFactorY = " & Me.GuyPullOffKFactorY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagKFactorX = " & Me.GuyDiagKFactorX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagKFactorY = " & Me.GuyDiagKFactorY.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyAutoCalc = " & Me.GuyAutoCalc.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyAllGuysSame = " & Me.GuyAllGuysSame.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyAllGuysAnchorSame = " & Me.GuyAllGuysAnchorSame.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyIsStrapping = " & Me.GuyIsStrapping.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffSize = " & Me.GuyPullOffSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffSizeBot = " & Me.GuyPullOffSizeBot.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffType = " & Me.GuyPullOffType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffGrade = " & Me.GuyPullOffGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffMatlGrade = " & Me.GuyPullOffMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyUpperDiagSize = " & Me.GuyUpperDiagSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyLowerDiagSize = " & Me.GuyLowerDiagSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagType = " & Me.GuyDiagType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagGrade = " & Me.GuyDiagGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagMatlGrade = " & Me.GuyDiagMatlGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagNetWidthDeduct = " & Me.GuyDiagNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagUFactor = " & Me.GuyDiagUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagNumBolts = " & Me.GuyDiagNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagonalOutOfPlaneRestraint = " & Me.GuyDiagonalOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagBoltGrade = " & Me.GuyDiagBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagBoltSize = " & Me.GuyDiagBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagBoltEdgeDistance = " & Me.GuyDiagBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyDiagBoltGageDistance = " & Me.GuyDiagBoltGageDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffNetWidthDeduct = " & Me.GuyPullOffNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffUFactor = " & Me.GuyPullOffUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffNumBolts = " & Me.GuyPullOffNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffOutOfPlaneRestraint = " & Me.GuyPullOffOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffBoltGrade = " & Me.GuyPullOffBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffBoltSize = " & Me.GuyPullOffBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffBoltEdgeDistance = " & Me.GuyPullOffBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPullOffBoltGageDistance = " & Me.GuyPullOffBoltGageDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmNetWidthDeduct = " & Me.GuyTorqueArmNetWidthDeduct.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmUFactor = " & Me.GuyTorqueArmUFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmNumBolts = " & Me.GuyTorqueArmNumBolts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmOutOfPlaneRestraint = " & Me.GuyTorqueArmOutOfPlaneRestraint.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmBoltGrade = " & Me.GuyTorqueArmBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmBoltSize = " & Me.GuyTorqueArmBoltSize.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmBoltEdgeDistance = " & Me.GuyTorqueArmBoltEdgeDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyTorqueArmBoltGageDistance = " & Me.GuyTorqueArmBoltGageDistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPerCentTension = " & Me.GuyPerCentTension.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPerCentTension120 = " & Me.GuyPerCentTension120.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPerCentTension240 = " & Me.GuyPerCentTension240.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyPerCentTension360 = " & Me.GuyPerCentTension360.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyEffFactor = " & Me.GuyEffFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyEffFactor120 = " & Me.GuyEffFactor120.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyEffFactor240 = " & Me.GuyEffFactor240.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyEffFactor360 = " & Me.GuyEffFactor360.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyNumInsulators = " & Me.GuyNumInsulators.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyInsulatorLength = " & Me.GuyInsulatorLength.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyInsulatorDia = " & Me.GuyInsulatorDia.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyInsulatorWt = " & Me.GuyInsulatorWt.ToString.FormatDBValue)
