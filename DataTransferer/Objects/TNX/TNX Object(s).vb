...
#Region "Save to EDS"
    ...
    Public Overrides Function SQLInsertValues() As String
        ...
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.DesignStandardSeries.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.UnitsSystem.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.ClientName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.ProjectName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.ProjectNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.CreatedBy.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.CreatedOn.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.LastUsedBy.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.LastUsedOn.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.projectInfo.VersionUsed.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Length.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Length.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Coordinate.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Coordinate.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Force.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Force.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Load.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Load.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Moment.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Moment.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Properties.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Properties.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Pressure.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Pressure.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Velocity.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Velocity.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Displacement.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Displacement.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Mass.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Mass.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Acceleration.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Acceleration.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Stress.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Stress.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Density.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Density.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.UnitWt.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.UnitWt.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Strength.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Strength.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Modulus.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Modulus.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Temperature.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Temperature.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Printer.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Printer.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Rotation.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Rotation.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Spacing.value.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.USUnits.Spacing.precision.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerUserName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerCompanyName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerStreetAddress.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerCityState.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerPhone.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerFAX.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerLogo.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.settings.userInfo.ViewerCompanyBitmap.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportProjectNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportJobType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCarrierName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCarrierSiteNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCarrierSiteName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportSiteAddress.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLatitudeDegree.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLatitudeMinute.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLatitudeSecond.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLongitudeDegree.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLongitudeMinute.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLongitudeSecond.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLocalCodeRequirement.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportSiteHistory.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportTowerManufacturer.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportMonthManufactured.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportYearManufactured.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportOriginalSpeed.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportOriginalCode.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportTowerType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportEngrName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportEngrTitle.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportHQPhoneNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportEmailAddress.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportLogoPath.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiContactName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiAddress1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiAddress2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiBUNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiSiteName.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiJDENumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiWONumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiPONumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiAppNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportCCiRevNumber.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportRecommendations.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note5.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note6.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt1Note7.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note5.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note6.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAppurt2Note7.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAddlCapacityNote1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAddlCapacityNote2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAddlCapacityNote3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.CCIReport.sReportAddlCapacityNote4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.DesignCode.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.TowerType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.AntennaType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.OverallHeight.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.BaseElevation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.Lambda.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.TowerTopFaceWidth.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.TowerBaseFaceWidth.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.WindSpeed.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.WindSpeedIce.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.WindSpeedService.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.ice.IceThickness.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.CSA_S37_RefVelPress.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.CSA_S37_ReliabilityClass.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.CSA_S37_ServiceabilityFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.ice.UseModified_TIA_222_IceParameters.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.ice.TIA_222_IceThicknessMultiplier.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.ice.DoNotUse_TIA_222_IceEscalation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.ice.IceDensity.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.seismic.SeismicSiteClass.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.seismic.SeismicSs.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.seismic.SeismicS1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.thermal.TempDrop.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.misclCode.GroutFc.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.defaultGirtOffsets.GirtOffset.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.defaultGirtOffsets.GirtOffsetLatticedPole.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.foundationStiffness.MastVert.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.foundationStiffness.MastHorz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.foundationStiffness.GuyVert.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.foundationStiffness.GuyHorz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.misclOptions.HogRodTakeup.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.TowerTaper.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.GuyedMonopoleBaseType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.TaperHeight.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.PivotHeight.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.AutoCalcGH.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.IncludeCapacityNote.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.IncludeAppurtGraphics.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.DisplayNotes.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.DisplayReactions.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.DisplaySchedule.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.DisplayAppurtenanceTable.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.DisplayMaterialStrengthTable.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.AutoCalc_ASCE_GH.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ASCE_ExposureCat.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ASCE_Year.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ASCEGh.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ASCEI.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.UseASCEWind.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.UserGHElev.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.UseCodeGuySF.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.GuySF.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.CalcWindAt.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.misclCode.TowerBoltGrade.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.misclCode.TowerBoltMinEdgeDist.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.AllowStressRatio.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.AllowAntStressRatio.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.WindCalcPoints.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.UseIndexPlate.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.EnterUserDefinedGhValues.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.BaseTowerGhInput.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.UpperStructureGhInput.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.EnterUserDefinedCgValues.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.BaseTowerCgInput.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.UpperStructureCgInput.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.CheckVonMises.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseClearSpans.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseClearSpansKlr.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.AntennaFaceWidth.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.DoInteraction.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.DoHorzInteraction.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.DoDiagInteraction.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.UseMomentMagnification.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseFeedlineAsCylinder.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.defaultGirtOffsets.OffsetBotGirt.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.PrintBitmaps.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.UseTopTakeup.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.geometry.ConstantSlope.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.UseCodeStressRatio.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseLegLoads.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.ERIDesignMode.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.WindExposure.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.WindZone.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.StructureCategory.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RiskCategory.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.TopoCategory.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RSMTopographicFeature.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RSM_L.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RSM_X.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.CrestHeight.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.TIA_222_H_TopoFeatureDownwind.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.BaseElevAboveSeaLevel.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ConsiderRooftopSpeedUp.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RooftopWS.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RooftopHS.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RooftopParapetHt.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.RooftopXB.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.UseTIA222H_AnnexS.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.design.TIA_222_H_AnnexS_Ratio.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.seismic.UseASCE7_10_Seismic_Lcomb.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.EIACWindMult.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.EIACWindMultIce.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.EIACIgnoreCableDrag.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.MTOSettings.Notes.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportInputCosts.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportInputGeometry.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportInputOptions.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportMaxForces.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportInputMap.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.CostReportOutputType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.CapacityReportOutputType.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintForceTotals.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintForceDetails.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintMastVectors.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintAntPoleVectors.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintDiscreteVectors.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintDishVectors.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintFeedTowerVectors.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintUserLoadVectors.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintPressures.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintAppurtForces.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintGuyForces.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintGuyStressing.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintDeflections.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintReactions.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintStressChecks.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintBoltChecks.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintInputGVerificationTables.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.reportSettings.ReportPrintOutputGVerificationTables.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.SocketTopMount.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.SRTakeCompression.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.AllLegPanelsSame.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseCombinedBoltCapacity.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.SecHorzBracesLeg.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.SortByComponent.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.SRCutEnds.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.SRConcentric.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.CalcBlockShear.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.Use4SidedDiamondBracing.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.TriangulateInnerBracing.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.PrintCarrierNotes.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.AddIBCWindCase.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.UseStateCountyLookup.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.State.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.County.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.LegBoltsAtTop.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.PrintMonopoleAtIncrements.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseTIA222Exemptions_MinBracingResistance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseTIA222Exemptions_TensionSplice.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.IgnoreKLryFor60DegAngleLegs.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ASCE_7_10_WindData.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.ASCE_7_10_ConvertWindToASD.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.solutionSettings.SolutionUsePDelta.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseFeedlineTorque.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UsePinnedElements.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.wind.UseMaxKz.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseRigidIndex.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseTrueCable.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseASCELy.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.CalcBracingForces.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.IgnoreBracingFEA.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.UseSubCriticalFlow.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.AssumePoleWithNoAttachments.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.AssumePoleWithShroud.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.PoleCornerRadiusKnown.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.solutionSettings.SolutionMinStiffness.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.solutionSettings.SolutionMaxStiffness.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.solutionSettings.SolutionMaxCycles.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.solutionSettings.SolutionPower.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.solutionSettings.SolutionTolerance.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.cantileverPoles.CantKFactor.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.misclOptions.RadiusSampleDist.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.BypassStabilityChecks.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseWindProjection.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.code.ice.UseIceEscalation.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.UseDishCoeff.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.AutoCalcTorqArmArea.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDirOption.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_0.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_5.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_6.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_7.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_8.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_9.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_10.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_11.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_12.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_13.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_14.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir0_15.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_0.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_5.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_6.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_7.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_8.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_9.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_10.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_11.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_12.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_13.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_14.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir1_15.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_0.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_1.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_2.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_3.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_4.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_5.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_6.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_7.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_8.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_9.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_10.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_11.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_12.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_13.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_14.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.WindDir2_15.ToString.FormatDBValue)
        SQLInsertValues = SQLInsertValues.AddtoDBString(Me.options.windDirections.SuppressWindPatternLoading.ToString.FormatDBValue)
    ...
    Public Overrides Function SQLUpdateFieldsandValues() As String
        ...
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DesignStandardSeries = " & Me.settings.projectInfo.DesignStandardSeries.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UnitsSystem = " & Me.settings.projectInfo.UnitsSystem.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ClientName = " & Me.settings.projectInfo.ClientName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ProjectName = " & Me.settings.projectInfo.ProjectName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ProjectNumber = " & Me.settings.projectInfo.ProjectNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CreatedBy = " & Me.settings.projectInfo.CreatedBy.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CreatedOn = " & Me.settings.projectInfo.CreatedOn.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("LastUsedBy = " & Me.settings.projectInfo.LastUsedBy.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("LastUsedOn = " & Me.settings.projectInfo.LastUsedOn.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("VersionUsed = " & Me.settings.projectInfo.VersionUsed.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USLength = " & Me.settings.USUnits.Length.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USLengthPrec = " & Me.settings.USUnits.Length.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USCoordinate = " & Me.settings.USUnits.Coordinate.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USCoordinatePrec = " & Me.settings.USUnits.Coordinate.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USForce = " & Me.settings.USUnits.Force.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USForcePrec = " & Me.settings.USUnits.Force.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USLoad = " & Me.settings.USUnits.Load.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USLoadPrec = " & Me.settings.USUnits.Load.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USMoment = " & Me.settings.USUnits.Moment.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USMomentPrec = " & Me.settings.USUnits.Moment.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USProperties = " & Me.settings.USUnits.Properties.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USPropertiesPrec = " & Me.settings.USUnits.Properties.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USPressure = " & Me.settings.USUnits.Pressure.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USPressurePrec = " & Me.settings.USUnits.Pressure.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USVelocity = " & Me.settings.USUnits.Velocity.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USVelocityPrec = " & Me.settings.USUnits.Velocity.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USDisplacement = " & Me.settings.USUnits.Displacement.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USDisplacementPrec = " & Me.settings.USUnits.Displacement.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USMass = " & Me.settings.USUnits.Mass.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USMassPrec = " & Me.settings.USUnits.Mass.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USAcceleration = " & Me.settings.USUnits.Acceleration.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USAccelerationPrec = " & Me.settings.USUnits.Acceleration.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USStress = " & Me.settings.USUnits.Stress.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USStressPrec = " & Me.settings.USUnits.Stress.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USDensity = " & Me.settings.USUnits.Density.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USDensityPrec = " & Me.settings.USUnits.Density.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USUnitWt = " & Me.settings.USUnits.UnitWt.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USUnitWtPrec = " & Me.settings.USUnits.UnitWt.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USStrength = " & Me.settings.USUnits.Strength.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USStrengthPrec = " & Me.settings.USUnits.Strength.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USModulus = " & Me.settings.USUnits.Modulus.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USModulusPrec = " & Me.settings.USUnits.Modulus.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USTemperature = " & Me.settings.USUnits.Temperature.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USTemperaturePrec = " & Me.settings.USUnits.Temperature.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USPrinter = " & Me.settings.USUnits.Printer.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USPrinterPrec = " & Me.settings.USUnits.Printer.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USRotation = " & Me.settings.USUnits.Rotation.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USRotationPrec = " & Me.settings.USUnits.Rotation.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USSpacing = " & Me.settings.USUnits.Spacing.value.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("USSpacingPrec = " & Me.settings.USUnits.Spacing.precision.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerUserName = " & Me.settings.userInfo.ViewerUserName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerCompanyName = " & Me.settings.userInfo.ViewerCompanyName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerStreetAddress = " & Me.settings.userInfo.ViewerStreetAddress.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerCityState = " & Me.settings.userInfo.ViewerCityState.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerPhone = " & Me.settings.userInfo.ViewerPhone.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerFAX = " & Me.settings.userInfo.ViewerFAX.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerLogo = " & Me.settings.userInfo.ViewerLogo.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ViewerCompanyBitmap = " & Me.settings.userInfo.ViewerCompanyBitmap.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportProjectNumber = " & Me.CCIReport.sReportProjectNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportJobType = " & Me.CCIReport.sReportJobType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCarrierName = " & Me.CCIReport.sReportCarrierName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCarrierSiteNumber = " & Me.CCIReport.sReportCarrierSiteNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCarrierSiteName = " & Me.CCIReport.sReportCarrierSiteName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportSiteAddress = " & Me.CCIReport.sReportSiteAddress.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLatitudeDegree = " & Me.CCIReport.sReportLatitudeDegree.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLatitudeMinute = " & Me.CCIReport.sReportLatitudeMinute.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLatitudeSecond = " & Me.CCIReport.sReportLatitudeSecond.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLongitudeDegree = " & Me.CCIReport.sReportLongitudeDegree.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLongitudeMinute = " & Me.CCIReport.sReportLongitudeMinute.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLongitudeSecond = " & Me.CCIReport.sReportLongitudeSecond.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLocalCodeRequirement = " & Me.CCIReport.sReportLocalCodeRequirement.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportSiteHistory = " & Me.CCIReport.sReportSiteHistory.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportTowerManufacturer = " & Me.CCIReport.sReportTowerManufacturer.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportMonthManufactured = " & Me.CCIReport.sReportMonthManufactured.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportYearManufactured = " & Me.CCIReport.sReportYearManufactured.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportOriginalSpeed = " & Me.CCIReport.sReportOriginalSpeed.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportOriginalCode = " & Me.CCIReport.sReportOriginalCode.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportTowerType = " & Me.CCIReport.sReportTowerType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportEngrName = " & Me.CCIReport.sReportEngrName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportEngrTitle = " & Me.CCIReport.sReportEngrTitle.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportHQPhoneNumber = " & Me.CCIReport.sReportHQPhoneNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportEmailAddress = " & Me.CCIReport.sReportEmailAddress.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportLogoPath = " & Me.CCIReport.sReportLogoPath.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiContactName = " & Me.CCIReport.sReportCCiContactName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiAddress1 = " & Me.CCIReport.sReportCCiAddress1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiAddress2 = " & Me.CCIReport.sReportCCiAddress2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiBUNumber = " & Me.CCIReport.sReportCCiBUNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiSiteName = " & Me.CCIReport.sReportCCiSiteName.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiJDENumber = " & Me.CCIReport.sReportCCiJDENumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiWONumber = " & Me.CCIReport.sReportCCiWONumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiPONumber = " & Me.CCIReport.sReportCCiPONumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiAppNumber = " & Me.CCIReport.sReportCCiAppNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportCCiRevNumber = " & Me.CCIReport.sReportCCiRevNumber.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportRecommendations = " & Me.CCIReport.sReportRecommendations.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note1 = " & Me.CCIReport.sReportAppurt1Note1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note2 = " & Me.CCIReport.sReportAppurt1Note2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note3 = " & Me.CCIReport.sReportAppurt1Note3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note4 = " & Me.CCIReport.sReportAppurt1Note4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note5 = " & Me.CCIReport.sReportAppurt1Note5.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note6 = " & Me.CCIReport.sReportAppurt1Note6.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt1Note7 = " & Me.CCIReport.sReportAppurt1Note7.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note1 = " & Me.CCIReport.sReportAppurt2Note1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note2 = " & Me.CCIReport.sReportAppurt2Note2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note3 = " & Me.CCIReport.sReportAppurt2Note3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note4 = " & Me.CCIReport.sReportAppurt2Note4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note5 = " & Me.CCIReport.sReportAppurt2Note5.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note6 = " & Me.CCIReport.sReportAppurt2Note6.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAppurt2Note7 = " & Me.CCIReport.sReportAppurt2Note7.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAddlCapacityNote1 = " & Me.CCIReport.sReportAddlCapacityNote1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAddlCapacityNote2 = " & Me.CCIReport.sReportAddlCapacityNote2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAddlCapacityNote3 = " & Me.CCIReport.sReportAddlCapacityNote3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("sReportAddlCapacityNote4 = " & Me.CCIReport.sReportAddlCapacityNote4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DesignCode = " & Me.code.design.DesignCode.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerType = " & Me.geometry.TowerType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaType = " & Me.geometry.AntennaType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("OverallHeight = " & Me.geometry.OverallHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("BaseElevation = " & Me.geometry.BaseElevation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Lambda = " & Me.geometry.Lambda.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTopFaceWidth = " & Me.geometry.TowerTopFaceWidth.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBaseFaceWidth = " & Me.geometry.TowerBaseFaceWidth.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindSpeed = " & Me.code.wind.WindSpeed.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindSpeedIce = " & Me.code.wind.WindSpeedIce.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindSpeedService = " & Me.code.wind.WindSpeedService.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IceThickness = " & Me.code.ice.IceThickness.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CSA_S37_RefVelPress = " & Me.code.wind.CSA_S37_RefVelPress.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CSA_S37_ReliabilityClass = " & Me.code.wind.CSA_S37_ReliabilityClass.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CSA_S37_ServiceabilityFactor = " & Me.code.wind.CSA_S37_ServiceabilityFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseModified_TIA_222_IceParameters = " & Me.code.ice.UseModified_TIA_222_IceParameters.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TIA_222_IceThicknessMultiplier = " & Me.code.ice.TIA_222_IceThicknessMultiplier.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DoNotUse_TIA_222_IceEscalation = " & Me.code.ice.DoNotUse_TIA_222_IceEscalation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IceDensity = " & Me.code.ice.IceDensity.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SeismicSiteClass = " & Me.code.seismic.SeismicSiteClass.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SeismicSs = " & Me.code.seismic.SeismicSs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SeismicS1 = " & Me.code.seismic.SeismicS1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TempDrop = " & Me.code.thermal.TempDrop.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GroutFc = " & Me.code.misclCode.GroutFc.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GirtOffset = " & Me.options.defaultGirtOffsets.GirtOffset.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GirtOffsetLatticedPole = " & Me.options.defaultGirtOffsets.GirtOffsetLatticedPole.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("MastVert = " & Me.options.foundationStiffness.MastVert.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("MastHorz = " & Me.options.foundationStiffness.MastHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyVert = " & Me.options.foundationStiffness.GuyVert.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyHorz = " & Me.options.foundationStiffness.GuyHorz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("HogRodTakeup = " & Me.options.misclOptions.HogRodTakeup.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerTaper = " & Me.geometry.TowerTaper.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuyedMonopoleBaseType = " & Me.geometry.GuyedMonopoleBaseType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TaperHeight = " & Me.geometry.TaperHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("PivotHeight = " & Me.geometry.PivotHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AutoCalcGH = " & Me.geometry.AutoCalcGH.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IncludeCapacityNote = " & Me.MTOSettings.IncludeCapacityNote.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IncludeAppurtGraphics = " & Me.MTOSettings.IncludeAppurtGraphics.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DisplayNotes = " & Me.MTOSettings.DisplayNotes.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DisplayReactions = " & Me.MTOSettings.DisplayReactions.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DisplaySchedule = " & Me.MTOSettings.DisplaySchedule.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DisplayAppurtenanceTable = " & Me.MTOSettings.DisplayAppurtenanceTable.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DisplayMaterialStrengthTable = " & Me.MTOSettings.DisplayMaterialStrengthTable.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AutoCalc_ASCE_GH = " & Me.code.wind.AutoCalc_ASCE_GH.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ASCE_ExposureCat = " & Me.code.wind.ASCE_ExposureCat.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ASCE_Year = " & Me.code.wind.ASCE_Year.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ASCEGh = " & Me.code.wind.ASCEGh.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ASCEI = " & Me.code.wind.ASCEI.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseASCEWind = " & Me.code.wind.UseASCEWind.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UserGHElev = " & Me.geometry.UserGHElev.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseCodeGuySF = " & Me.code.design.UseCodeGuySF.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("GuySF = " & Me.code.design.GuySF.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CalcWindAt = " & Me.code.wind.CalcWindAt.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBoltGrade = " & Me.code.misclCode.TowerBoltGrade.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TowerBoltMinEdgeDist = " & Me.code.misclCode.TowerBoltMinEdgeDist.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AllowStressRatio = " & Me.code.design.AllowStressRatio.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AllowAntStressRatio = " & Me.code.design.AllowAntStressRatio.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindCalcPoints = " & Me.code.wind.WindCalcPoints.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseIndexPlate = " & Me.geometry.UseIndexPlate.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("EnterUserDefinedGhValues = " & Me.geometry.EnterUserDefinedGhValues.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("BaseTowerGhInput = " & Me.geometry.BaseTowerGhInput.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UpperStructureGhInput = " & Me.geometry.UpperStructureGhInput.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("EnterUserDefinedCgValues = " & Me.geometry.EnterUserDefinedCgValues.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("BaseTowerCgInput = " & Me.geometry.BaseTowerCgInput.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UpperStructureCgInput = " & Me.geometry.UpperStructureCgInput.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CheckVonMises = " & Me.options.cantileverPoles.CheckVonMises.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseClearSpans = " & Me.options.UseClearSpans.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseClearSpansKlr = " & Me.options.UseClearSpansKlr.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AntennaFaceWidth = " & Me.geometry.AntennaFaceWidth.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DoInteraction = " & Me.code.design.DoInteraction.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DoHorzInteraction = " & Me.code.design.DoHorzInteraction.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("DoDiagInteraction = " & Me.code.design.DoDiagInteraction.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseMomentMagnification = " & Me.code.design.UseMomentMagnification.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseFeedlineAsCylinder = " & Me.options.UseFeedlineAsCylinder.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("OffsetBotGirt = " & Me.options.defaultGirtOffsets.OffsetBotGirt.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("PrintBitmaps = " & Me.code.design.PrintBitmaps.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseTopTakeup = " & Me.geometry.UseTopTakeup.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ConstantSlope = " & Me.geometry.ConstantSlope.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseCodeStressRatio = " & Me.code.design.UseCodeStressRatio.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseLegLoads = " & Me.options.UseLegLoads.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ERIDesignMode = " & Me.code.design.ERIDesignMode.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindExposure = " & Me.code.wind.WindExposure.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindZone = " & Me.code.wind.WindZone.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("StructureCategory = " & Me.code.wind.StructureCategory.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RiskCategory = " & Me.code.wind.RiskCategory.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TopoCategory = " & Me.code.wind.TopoCategory.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RSMTopographicFeature = " & Me.code.wind.RSMTopographicFeature.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RSM_L = " & Me.code.wind.RSM_L.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RSM_X = " & Me.code.wind.RSM_X.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CrestHeight = " & Me.code.wind.CrestHeight.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TIA_222_H_TopoFeatureDownwind = " & Me.code.wind.TIA_222_H_TopoFeatureDownwind.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("BaseElevAboveSeaLevel = " & Me.code.wind.BaseElevAboveSeaLevel.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ConsiderRooftopSpeedUp = " & Me.code.wind.ConsiderRooftopSpeedUp.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RooftopWS = " & Me.code.wind.RooftopWS.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RooftopHS = " & Me.code.wind.RooftopHS.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RooftopParapetHt = " & Me.code.wind.RooftopParapetHt.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RooftopXB = " & Me.code.wind.RooftopXB.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseTIA222H_AnnexS = " & Me.code.design.UseTIA222H_AnnexS.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TIA_222_H_AnnexS_Ratio = " & Me.code.design.TIA_222_H_AnnexS_Ratio.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseASCE7_10_Seismic_LComb = " & Me.code.seismic.UseASCE7_10_Seismic_Lcomb.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("EIACWindMult = " & Me.code.wind.EIACWindMult.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("EIACWindMultIce = " & Me.code.wind.EIACWindMultIce.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("EIACIgnoreCableDrag = " & Me.code.wind.EIACIgnoreCableDrag.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Notes = " & Me.MTOSettings.Notes.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportInputCosts = " & Me.reportSettings.ReportInputCosts.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportInputGeometry = " & Me.reportSettings.ReportInputGeometry.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportInputOptions = " & Me.reportSettings.ReportInputOptions.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportMaxForces = " & Me.reportSettings.ReportMaxForces.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportInputMap = " & Me.reportSettings.ReportInputMap.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CostReportOutputType = " & Me.reportSettings.CostReportOutputType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CapacityReportOutputType = " & Me.reportSettings.CapacityReportOutputType.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintForceTotals = " & Me.reportSettings.ReportPrintForceTotals.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintForceDetails = " & Me.reportSettings.ReportPrintForceDetails.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintMastVectors = " & Me.reportSettings.ReportPrintMastVectors.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintAntPoleVectors = " & Me.reportSettings.ReportPrintAntPoleVectors.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintDiscreteVectors = " & Me.reportSettings.ReportPrintDiscreteVectors.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintDishVectors = " & Me.reportSettings.ReportPrintDishVectors.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintFeedTowerVectors = " & Me.reportSettings.ReportPrintFeedTowerVectors.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintUserLoadVectors = " & Me.reportSettings.ReportPrintUserLoadVectors.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintPressures = " & Me.reportSettings.ReportPrintPressures.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintAppurtForces = " & Me.reportSettings.ReportPrintAppurtForces.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintGuyForces = " & Me.reportSettings.ReportPrintGuyForces.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintGuyStressing = " & Me.reportSettings.ReportPrintGuyStressing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintDeflections = " & Me.reportSettings.ReportPrintDeflections.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintReactions = " & Me.reportSettings.ReportPrintReactions.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintStressChecks = " & Me.reportSettings.ReportPrintStressChecks.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintBoltChecks = " & Me.reportSettings.ReportPrintBoltChecks.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintInputGVerificationTables = " & Me.reportSettings.ReportPrintInputGVerificationTables.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ReportPrintOutputGVerificationTables = " & Me.reportSettings.ReportPrintOutputGVerificationTables.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SocketTopMount = " & Me.options.cantileverPoles.SocketTopMount.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SRTakeCompression = " & Me.options.SRTakeCompression.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AllLegPanelsSame = " & Me.options.AllLegPanelsSame.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseCombinedBoltCapacity = " & Me.options.UseCombinedBoltCapacity.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SecHorzBracesLeg = " & Me.options.SecHorzBracesLeg.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SortByComponent = " & Me.options.SortByComponent.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SRCutEnds = " & Me.options.SRCutEnds.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SRConcentric = " & Me.options.SRConcentric.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CalcBlockShear = " & Me.options.CalcBlockShear.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("Use4SidedDiamondBracing = " & Me.options.Use4SidedDiamondBracing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("TriangulateInnerBracing = " & Me.options.TriangulateInnerBracing.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("PrintCarrierNotes = " & Me.options.PrintCarrierNotes.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AddIBCWindCase = " & Me.options.AddIBCWindCase.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseStateCountyLookup = " & Me.code.wind.UseStateCountyLookup.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("State = " & Me.code.wind.State.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("County = " & Me.code.wind.County.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("LegBoltsAtTop = " & Me.options.LegBoltsAtTop.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("PrintMonopoleAtIncrements = " & Me.options.cantileverPoles.PrintMonopoleAtIncrements.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseTIA222Exemptions_MinBracingResistance = " & Me.options.UseTIA222Exemptions_MinBracingResistance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseTIA222Exemptions_TensionSplice = " & Me.options.UseTIA222Exemptions_TensionSplice.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IgnoreKLryFor60DegAngleLegs = " & Me.options.IgnoreKLryFor60DegAngleLegs.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ASCE_7_10_WindData = " & Me.code.wind.ASCE_7_10_WindData.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("ASCE_7_10_ConvertWindToASD = " & Me.code.wind.ASCE_7_10_ConvertWindToASD.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SolutionUsePDelta = " & Me.solutionSettings.SolutionUsePDelta.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseFeedlineTorque = " & Me.options.UseFeedlineTorque.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UsePinnedElements = " & Me.options.UsePinnedElements.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseMaxKz = " & Me.code.wind.UseMaxKz.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseRigidIndex = " & Me.options.UseRigidIndex.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseTrueCable = " & Me.options.UseTrueCable.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseASCELy = " & Me.options.UseASCELy.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CalcBracingForces = " & Me.options.CalcBracingForces.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("IgnoreBracingFEA = " & Me.options.IgnoreBracingFEA.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseSubCriticalFlow = " & Me.options.cantileverPoles.UseSubCriticalFlow.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AssumePoleWithNoAttachments = " & Me.options.cantileverPoles.AssumePoleWithNoAttachments.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AssumePoleWithShroud = " & Me.options.cantileverPoles.AssumePoleWithShroud.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("PoleCornerRadiusKnown = " & Me.options.cantileverPoles.PoleCornerRadiusKnown.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SolutionMinStiffness = " & Me.solutionSettings.SolutionMinStiffness.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SolutionMaxStiffness = " & Me.solutionSettings.SolutionMaxStiffness.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SolutionMaxCycles = " & Me.solutionSettings.SolutionMaxCycles.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SolutionPower = " & Me.solutionSettings.SolutionPower.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SolutionTolerance = " & Me.solutionSettings.SolutionTolerance.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("CantKFactor = " & Me.options.cantileverPoles.CantKFactor.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("RadiusSampleDist = " & Me.options.misclOptions.RadiusSampleDist.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("BypassStabilityChecks = " & Me.options.BypassStabilityChecks.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseWindProjection = " & Me.options.UseWindProjection.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseIceEscalation = " & Me.code.ice.UseIceEscalation.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("UseDishCoeff = " & Me.options.UseDishCoeff.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("AutoCalcTorqArmArea = " & Me.options.AutoCalcTorqArmArea.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDirOption = " & Me.options.windDirections.WindDirOption.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_0 = " & Me.options.windDirections.WindDir0_0.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_1 = " & Me.options.windDirections.WindDir0_1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_2 = " & Me.options.windDirections.WindDir0_2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_3 = " & Me.options.windDirections.WindDir0_3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_4 = " & Me.options.windDirections.WindDir0_4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_5 = " & Me.options.windDirections.WindDir0_5.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_6 = " & Me.options.windDirections.WindDir0_6.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_7 = " & Me.options.windDirections.WindDir0_7.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_8 = " & Me.options.windDirections.WindDir0_8.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_9 = " & Me.options.windDirections.WindDir0_9.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_10 = " & Me.options.windDirections.WindDir0_10.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_11 = " & Me.options.windDirections.WindDir0_11.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_12 = " & Me.options.windDirections.WindDir0_12.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_13 = " & Me.options.windDirections.WindDir0_13.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_14 = " & Me.options.windDirections.WindDir0_14.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir0_15 = " & Me.options.windDirections.WindDir0_15.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_0 = " & Me.options.windDirections.WindDir1_0.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_1 = " & Me.options.windDirections.WindDir1_1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_2 = " & Me.options.windDirections.WindDir1_2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_3 = " & Me.options.windDirections.WindDir1_3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_4 = " & Me.options.windDirections.WindDir1_4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_5 = " & Me.options.windDirections.WindDir1_5.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_6 = " & Me.options.windDirections.WindDir1_6.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_7 = " & Me.options.windDirections.WindDir1_7.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_8 = " & Me.options.windDirections.WindDir1_8.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_9 = " & Me.options.windDirections.WindDir1_9.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_10 = " & Me.options.windDirections.WindDir1_10.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_11 = " & Me.options.windDirections.WindDir1_11.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_12 = " & Me.options.windDirections.WindDir1_12.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_13 = " & Me.options.windDirections.WindDir1_13.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_14 = " & Me.options.windDirections.WindDir1_14.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir1_15 = " & Me.options.windDirections.WindDir1_15.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_0 = " & Me.options.windDirections.WindDir2_0.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_1 = " & Me.options.windDirections.WindDir2_1.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_2 = " & Me.options.windDirections.WindDir2_2.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_3 = " & Me.options.windDirections.WindDir2_3.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_4 = " & Me.options.windDirections.WindDir2_4.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_5 = " & Me.options.windDirections.WindDir2_5.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_6 = " & Me.options.windDirections.WindDir2_6.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_7 = " & Me.options.windDirections.WindDir2_7.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_8 = " & Me.options.windDirections.WindDir2_8.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_9 = " & Me.options.windDirections.WindDir2_9.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_10 = " & Me.options.windDirections.WindDir2_10.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_11 = " & Me.options.windDirections.WindDir2_11.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_12 = " & Me.options.windDirections.WindDir2_12.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_13 = " & Me.options.windDirections.WindDir2_13.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_14 = " & Me.options.windDirections.WindDir2_14.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("WindDir2_15 = " & Me.options.windDirections.WindDir2_15.ToString.FormatDBValue)
        SQLUpdateFieldsandValues = SQLUpdateFieldsandValues.AddtoDBString("SuppressWindPatternLoading = " & Me.options.windDirections.SuppressWindPatternLoading.ToString.FormatDBValue)
