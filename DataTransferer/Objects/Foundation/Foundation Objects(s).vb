...
'#Region "Save to EDS"
'    'Moved to EDSObjectWith Queries
'    'Public MustOverride Function InsertUpdateDelete() As String

'    'Public MustOverride Function GenerateSQLInsertValues() As String

'    'Public MustOverride Function GenerateSQLUpdate() As String
